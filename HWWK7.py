# -*- coding: utf-8 -*-
"""
Created on Thu Nov 18 10:59:09 2021
...
st.title("K-Means What Hey Means")
inslider = st.slider("Number of Iterations", 1, 10)
...
kmeans = KMeans(n_clusters = 5, max_iter=inslider, init=starting_points, n_init = 1)
kmeans.fit(X);
